    ...
    return (
      <View style={styles.container}>
        <EmptyState
          ...
          subtitle="Connect with tutors or parents to start messaging and coordinate lessons"
        ...
        <View style={styles.emptyStateFooter}>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push('/newGroup')}
          >
            <Text style={styles.secondaryButtonText}>Create a Parent Group</Text>
          </TouchableOpacity>
        </View>
      </View>
    );
